...
public class AdminService {
    ...
    public Admin login(Admin admin) {
        ...
        //然后拿数据库的密码和用户输入的密码匹配是否相同
        if (adminLogin != null && bCryptPasswordEncoder.matches(admin.getPassword(),
    ...
    public Page<Admin> findSearch(Map whereMap, int page, int size) {
        ...
        return adminDao.findAll(specification, myPageQuery.pageQuery(page, size));
    }
